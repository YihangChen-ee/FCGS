...
We alongside publish a CUDA-based arithmetic codec implementation, you can find it in [arithmetic.zip](https://github.com/YihangChen-ee/FCGS/blob/main/submodules/arithmetic.zip) and find its usage [here](https://github.com/YihangChen-ee/FCGS/blob/main/model/encodings_cuda.py).
